  ...
  <div class="centered">
    <div class="container">
      ...
      <form @submit.prevent="createUser()">
        ...
        <div class="form-group">
          <div class="col-md-12">
            <div class="radio-btn"><input type="radio" name="role" id="admin" value=1 v-model="input.role" required/><label for="admin" style="padding-left: 30px"> Admin</label></div>
            <div class="radio-btn"><input type="radio" name="role" id="dentist" value=2 v-model="input.role" /><label for="dentist" style="padding-left: 30px"> Dentist</label></div>
            <div class="radio-btn"><input type="radio" name="role" id="receptionist" value=3 v-model="input.role" /><label for="receptionist" style="padding-left: 30px"> Receptionist</label></div>
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12">
